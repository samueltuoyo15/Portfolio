...
export const Navbar = () => {
    ...
    return (
        ...
        >
            <div className="w-full max-w-[34rem] md:max-w-6xl px-4 md:px-6 py-3 sm:py-4 flex flex-nowrap justify-center md:justify-between items-center gap-2">
                <a href="#" className="hidden md:flex items-center gap-3 group shrink-0 min-w-0">
                    <div className="w-9 h-9 rounded-full overflow-hidden border border-gray-200 relative group-hover:scale-105 transition duration-300 shrink-0">
                        <Image
                            src="/avatar.jpg"
                            alt="Samuel Tuoyo"
                            fill
                    ...
                    <span className="font-bold text-base md:text-lg tracking-tight text-gray-900 group-hover:text-blue-600 transition truncate">
                        Samuel Tuoyo
                    </span>
                </a>
